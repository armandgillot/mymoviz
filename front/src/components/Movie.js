  ...
  return (
    <Col xs="12" lg="6" xl="4">
      <Card style={{ marginBottom: 30 }}>
        ...
        <CardBody>
          <p>Like <FontAwesomeIcon style={colorLike} icon={faHeart} onClick={() => handleClickAddMovieParent()} /></p>
        ...
        ({nbTotalVote})
          ...
          <CardTitle style={{ fontWeight: "bold", fontSize: "20px" }}>{props.movieName}</CardTitle>
